...
// Store swipe state in a ref outside the component to avoid conditional hook calls
const swipeStateRef = { startX: 0, currentX: 0 };
...
function Sidebar({
    ...
    const handleTouchStart = (e: React.TouchEvent) => {
        ...
        swipeStateRef.currentX = e.touches[0].clientX;
    };
    const handleTouchMove = (e: React.TouchEvent) => {
        swipeStateRef.currentX = e.touches[0].clientX;
    };
    const handleTouchEnd = () => {
        const deltaX = swipeStateRef.currentX - swipeStateRef.startX;
        if ((side === 'left' && deltaX < -threshold) || (side === 'right' && deltaX > threshold)) {
            setOpenMobile(false);
        }
    };
