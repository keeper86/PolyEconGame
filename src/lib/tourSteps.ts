  ...
  switch (page) {
    case 'central-bank':
      ...
      steps.push({
        ...
        after: () => {
          routerPush(`/planets/${encodeURIComponent(planetId)}/agent/${encodeURIComponent(agentId)}/financial`);
        },
        zIndex: 10000,
      });
      break;
    ...
    case 'financial':
      ...
      steps.push({
        target: 'body',
        content:
          'Now let\u2019s look at hiring workers. Your company needs a workforce to produce goods.',
        ...
        after: () => {
          routerPush(`/planets/${encodeURIComponent(planetId)}/agent/${encodeURIComponent(agentId)}/workforce`);
        },
        zIndex: 10000,
      });
      break;
    ...
    case 'workforce':
      ...
      steps.push({
        target: 'body',
        content:
          'Before you can produce, you need land and resources. Let\u2019s go to Land Claims.',
    ...
    case 'claims':
      ...
      steps.push({
        ...
        after: () => {
          routerPush(`/planets/${encodeURIComponent(planetId)}/agent/${encodeURIComponent(agentId)}/production`);
        },
        zIndex: 10000,
      });
      break;
    ...
    case 'production':
      ...
      steps.push({
        target: 'body',
        content:
          'Your products are stored in your warehouse. Let\u2019s check your storage.',
    ...
    case 'storage':
      ...
      steps.push({
        target: 'body',
        content:
          'Now let\u2019s see the Market where you can buy inputs and sell your finished goods.',
        title: '\u27A1\uFE0F Next: Market',
        placement: 'center',
        hideOverlay: false,
        locale: {
    ...
    case 'market':
      ...
      steps.push({
        target: 'body',
        content:
          'Finally, let\u2019s look at Ships \u2014 your gateway to interplanetary trade and expansion.',
        title: '\u27A1\uFE0F Next: Ships',
        placement: 'center',
        hideOverlay: false,
        locale: {
