...
export const TARGET_FILL_RATE = 0.9;
export const TARGET_FILL_RATE_SERVICES = 0.95;
export const TARGET_SELL_THROUGH = 0.9;
export const TARGET_SELL_THROUGH_SERVICES = 0.95;
export const AUTOMATED_COST_FLOOR_BUFFER = 1.5;

export const STARTER_LOAN_AMOUNT = 10_000_000;
