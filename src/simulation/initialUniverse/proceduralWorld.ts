...
const TARGETS: Record<string, FacilityTarget> = {
    administrativeCenter: { totalScale: 67569, agentCount: Math.ceil(flatTargetFactor * 2) },
    ...
    cementPlant: { totalScale: 239616, agentCount: Math.ceil(flatTargetFactor * 3) },
    clothingFactory: { totalScale: 208124, agentCount: Math.ceil(flatTargetFactor * 3) },
    coalMine: { totalScale: 22521, agentCount: Math.ceil(flatTargetFactor * 2) },
    concretePlant: { totalScale: 299520, agentCount: Math.ceil(flatTargetFactor * 3) },
    constructionFacility: { totalScale: 499200, agentCount: Math.ceil(flatTargetFactor * 5) },
    ...
    cottonFarm: { totalScale: 230918, agentCount: Math.ceil(flatTargetFactor * 3) },
    ...
    furnitureFactory: { totalScale: 254822, agentCount: Math.ceil(flatTargetFactor * 3) },
    ...
    ironMine: { totalScale: 79587, agentCount: Math.ceil(flatTargetFactor * 2) },
    ironSmelter: { totalScale: 212232, agentCount: Math.ceil(flatTargetFactor * 3) },
    itDevicesFactory: { totalScale: 624372, agentCount: Math.ceil(flatTargetFactor * 6) },
    limestoneQuarry: { totalScale: 74587, agentCount: Math.ceil(flatTargetFactor * 2) },
    loggingCamp: { totalScale: 203372, agentCount: Math.ceil(flatTargetFactor * 3) },
    logisticsHub: { totalScale: 945906, agentCount: Math.ceil(flatTargetFactor * 8) },
    machineryFactory: { totalScale: 11786, agentCount: Math.ceil(flatTargetFactor * 2) },
    maintenanceFacility: { totalScale: 1, agentCount: Math.ceil(flatTargetFactor * 2) },
    oilRefinery: { totalScale: 549971, agentCount: Math.ceil(flatTargetFactor * 5) },
    oilWell: { totalScale: 549971, agentCount: Math.ceil(flatTargetFactor * 5) },
    packagingPlant: { totalScale: 17951, agentCount: Math.ceil(flatTargetFactor * 2) },
    paperMill: { totalScale: 16340, agentCount: Math.ceil(flatTargetFactor * 2) },
    ...
    sandMine: { totalScale: 296019, agentCount: Math.ceil(flatTargetFactor * 3) },
    sawmill: { totalScale: 127411, agentCount: Math.ceil(flatTargetFactor * 2) },
    siliconWaferFactory: { totalScale: 156093, agentCount: Math.ceil(flatTargetFactor * 3) },
    stoneQuarry: { totalScale: 119808, agentCount: Math.ceil(flatTargetFactor * 2) },
    textileMill: { totalScale: 192432, agentCount: Math.ceil(flatTargetFactor * 3) },
    vehicleFactory: { totalScale: 9009, agentCount: Math.ceil(flatTargetFactor * 2) },
    waterFacility: { totalScale: 224160, agentCount: Math.ceil(flatTargetFactor * 3) },
};
