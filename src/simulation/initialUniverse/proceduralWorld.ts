...
const TARGETS: Record<string, FacilityTarget> = {
    administrativeCenter: { totalScale: 391791, agentCount: Math.ceil(flatTargetFactor * 4) },
    ...
    coalMine: { totalScale: 71646, agentCount: Math.ceil(flatTargetFactor * 2) },
    ...
    cottonFarm: { totalScale: 320573, agentCount: Math.ceil(flatTargetFactor * 4) },
    ...
    furnitureFactory: { totalScale: 448750, agentCount: Math.ceil(flatTargetFactor * 4) },
    glassFactory: { totalScale: 266832, agentCount: Math.ceil(flatTargetFactor * 3) },
    ...
    ironMine: { totalScale: 298606, agentCount: Math.ceil(flatTargetFactor * 3) },
    ironSmelter: { totalScale: 796283, agentCount: Math.ceil(flatTargetFactor * 7) },
    ...
    loggingCamp: { totalScale: 364197, agentCount: Math.ceil(flatTargetFactor * 4) },
    logisticsHub: { totalScale: 1257127, agentCount: Math.ceil(flatTargetFactor * 10) },
    machineryFactory: { totalScale: 66907, agentCount: Math.ceil(flatTargetFactor * 2) },
    maintenanceFacility: { totalScale: 1, agentCount: Math.ceil(flatTargetFactor * 2) },
    oilRefinery: { totalScale: 1002908, agentCount: Math.ceil(flatTargetFactor * 8) },
    oilWell: { totalScale: 1002908, agentCount: Math.ceil(flatTargetFactor * 8) },
    packagingPlant: { totalScale: 23899, agentCount: Math.ceil(flatTargetFactor * 2) },
    paperMill: { totalScale: 36846, agentCount: Math.ceil(flatTargetFactor * 2) },
    ...
    sandMine: { totalScale: 485082, agentCount: Math.ceil(flatTargetFactor * 5) },
    sawmill: { totalScale: 224375, agentCount: Math.ceil(flatTargetFactor * 3) },
    ...
    textileMill: { totalScale: 267144, agentCount: Math.ceil(flatTargetFactor * 3) },
    vehicleFactory: { totalScale: 11973, agentCount: Math.ceil(flatTargetFactor * 2) },
    waterFacility: { totalScale: 365462, agentCount: Math.ceil(flatTargetFactor * 4) },
};
