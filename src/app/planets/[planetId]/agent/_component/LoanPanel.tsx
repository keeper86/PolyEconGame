...
import { AlertCircle, BadgeDollarSign, CheckCircle2, ChevronDown, ChevronUp, Landmark } from 'lucide-react';
        ...
        <div className='border rounded-md p-3 space-y-3'>
            ...
            >
                <div className='flex items-center gap-2'>
                    ...
                    <span className='text-sm font-semibold'>Borrow from Bank</span>
                </div>
                {expanded ? (
            ...
            {expanded && (
                <>
                    ...
                    {conditions && (
                        <div className='space-y-1'>
                            ...
                            <Stat
                                ...
                                valueClassName={
                                    conditions.maxLoanAmount > 0 ? 'text-green-600' : 'text-muted-foreground'
                                }
                            />
                            <Stat
                            ...
                            {conditions.isNewAgent ? (
                                <p className='text-xs text-muted-foreground mt-1'>
                                    Starter loan — no revenue history yet.
                                </p>
                            ) : (
                                <>
                                    <Stat
                                    ...
                                    <Stat
                                        ...
                                        valueClassName={
                                            conditions.monthlyNetCashFlow >= 0 ? 'text-green-600' : 'text-red-500'
                                        }
                                    />
                                </>
                            )}
                    ...
                    {conditions && conditions.maxLoanAmount === 0 && (
                        <p className='text-xs text-muted-foreground'>
                            The bank is not offering additional credit at this time. Improve your cash flow (increase
                            revenue or reduce costs) to unlock further borrowing.
                        </p>
                    )}
                </>
            )}
