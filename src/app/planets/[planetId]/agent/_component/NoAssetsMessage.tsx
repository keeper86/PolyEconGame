...
export function NoAssetsMessage({ planetName, agentId, isOwnAgent }: Props) {
    return (
        <div className='space-y-4'>
            ...
            {isOwnAgent && (
                <LicensePanel agentId={agentId} planetId={planetName} isOwnAgent={true} licenses={undefined} />
            )}
        </div>
    );
}
