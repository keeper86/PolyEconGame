...
export default function NutritionHeatmapChart({ demography }: Props): React.ReactElement {
    ...
    return (
        <ChartCard
            ...
            secondaryControls={<CohortFilter value={filter} onChange={setFilter} compact />}
        >
            {/* Summary stats */}
            ...
            {/* Band legend */}
            <div className='flex flex-wrap gap-x-2 gap-y-0.5 text-[9px] text-muted-foreground mb-2'>
                {BANDS.map((b) => (
